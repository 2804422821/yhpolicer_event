      ...
      <el-card class="box-card">
        <template #header>
          <div class="card-header">
            <span class="card-header-text">案件评查</span>
            <div>
              <el-button
                  type="primary"
                  plain
        ...
        >
          ...
          <el-table-column label="案件编号" align="center" prop="id"/>
          <el-table-column label="案件名称" align="center" prop="id"/>
          <el-table-column label="评查类型" align="center" prop="id"/>
          <el-table-column label="送审类型" align="center" prop="id"/>
          <el-table-column label="主办人" align="center" prop="id"/>
          <el-table-column label="嫌疑人" align="center" prop="id"/>
          <el-table-column label="主办单位" align="center" prop="id"/>
          <el-table-column label="评查人" align="center" prop="id"/>
